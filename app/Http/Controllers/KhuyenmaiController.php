...
class KhuyenmaiController extends Controller
{
    ...
    public function postAdd(KhuyenmaiAddRequest $request)
    {
        ...
        $request->file('fImage')->move(
            base_path() . '/upload/khuyenmai/', $filename
        );
    ...
    public function getDelete($id)
    {
        ...
        $img = 'upload/khuyenmai/'.$khuyenmai->khuyenmai_anh;
        File::delete($img);
    ...
    public function postEdit(Request $request,$id)
    {
        ...
        $img_current = 'upload/khuyenmai/'.$request->fImageCurrent;
        if (!empty($fImage )) {
             ...
             $fImage ->move(base_path() . 'upload/khuyenmai/', $filename);
