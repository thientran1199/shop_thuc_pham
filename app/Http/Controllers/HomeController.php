...
class HomeController extends Controller
{
    ...
    public function buyding(Request $request,$id)
    {
        ...
        if ($sanpham[0]->sanpham_khuyenmai == 1) {
            ...
            print_r($giakm);
            Cart::add(array( 'id' => $muasanpham[0]->id, 'name' => $muasanpham[0]->sanpham_ten, 'qty' => 1, 'weight' => '100','price' => $giakm));
        } else {
            ...
            Cart::add(array( 'id' => $muasanpham[0]->id, 'name' => $muasanpham[0]->sanpham_ten, 'qty' => 1,'weight' => '100','price' => $gia));
        }
    ...
    public function postCheckin(ThanhtoanRequest $request)
    {
        ...
        Mail::send('auth.emails.hoadon', $donhang, function ($message) use ($donhang) {
            $message->from('vvvanvo1206vv@gmail.com', 'ADMIN');

            $message->to('vvvanvo1206vv@gmail.com', 'KHÁCH HÀNG');
