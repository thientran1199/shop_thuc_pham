...
class TuyendungController extends Controller
{
    ...
    public function postAdd(TuyendungAddRequest $request)
    {
        ...
        $request->file('fImage')->move(
            base_path() . 'upload/tuyendung/', $imageName
        );
    ...
    public function getDelete($id)
    {
        ...
        $img = 'upload/tuyendung/'.$tuyendung->tuyendung_anh;
        File::delete($img);
    ...
    public function postEdit(TuyendungEditRequest $request, $id)
    {
        ...
        $img_current = 'upload/tuyendung/'.$request->fImageCurrent;
        if (!empty($fImage )) {
             ...
             $fImage ->move(base_path() . 'upload/tuyendung/', $filename);
