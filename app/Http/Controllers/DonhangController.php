...
class DonhangController extends Controller
{
    ...
    {
    	$tinhtrangdh = DB::table('tinhtranghd')->get();
    	...
    	return view('backend.donhang.sua',compact('donhang','tinhtrangdh','khachhang','chitiet'));
    }
    ...
    public function pdf($id)
    {
        ...
        $khachhang = DB::table('khachhang')->where('id',$donhang->khachhang_id)->first();
        // print_r($khachhang);
        $pdf = PDF::loadview('xemnhanh',$donhang,$chitietdonhang,$khachhang);
        return $pdf->stream();
    }
}
