...
class MonngonController extends Controller
{
    ...
    public function postAdd(MonngonAddRequest $request)
    {
        ...
        $request->file('fImage')->move(
            base_path() . 'upload/monngon/', $filename
        );
    	$monngon = new Monngon();
    ...
    public function getDelete($id)
    {
        ...
        $img = 'upload/monngon/'.$monngon->monngon_anh;
        File::delete($img);
    ...
    public function postEdit(MonngonEditRequest $request,$id)
    {
        ...
        $img_current = 'upload/monngon/'.$request->fImageCurrent;
        if (!empty($fImage )) {
             ...
             $fImage ->move(base_path() . 'upload/monngon/', $filename);
