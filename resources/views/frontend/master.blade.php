          ...
          <div class="col-md-12">
            ...
            <!-- start header top left -->
              <div class="aa-header-top-left">
                ...
                <!-- start cellphone -->
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>0775275597</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  @if (Auth::check())
                    ...
                    <li class="hidden-xs"><a href="{{ asset('/logout') }}">Thoát</a></li>
                  @else
                    <li class="hidden-xs"><a href="{{ asset('/register') }}">Đăng kí</a></li>
                    <li class="hidden-xs"><a href="{{ asset('/login') }}">Đăng nhập</a></li>
                  @endif
                </ul>
              </div>
            </div>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{!! asset('/') !!}">
                  ...
                  <p>Thiện<strong>Trần</strong> <span>Good food - Good health</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="{!! asset('gio-hang') !!}">
