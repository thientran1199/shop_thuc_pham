...
@section('content')
  ...
  <section id="aa-catg-head-banner">
   <img src="{{ asset('images/ooooo.jpg') }}" alt="fashion img" style="width: 1920px; height: 300px;" >
                  ...
                  <div class="col-md-4 col-sm-4">
                      <article class="aa-latest-blog-single">
                        <figure class="aa-blog-img">
                          <a href="{{ url('mon-ngon',$item->monngon_url) }}"><img src="{{ asset('upload/monngon/'.$item->monngon_anh) }}"  style="width: 450px; height: 220px;"></a>
