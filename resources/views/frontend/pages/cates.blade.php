...
@section('content')
  ...
  <section id="aa-catg-head-banner">
   <img src="{{ asset('upload/loaisanpham/'.$loaisanpham->loaisanpham_anh) }}" alt="fashion img" style="width: 1920px; height: 300px;">
          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <li>
                  <figure>
                    <a class="aa-product-img" href="{{ url('san-pham',$item->sanpham_url) }}"><img src="{{ asset('upload/sanpham/'.$item->sanpham_anh) }}"  style="width: 250px; height: 300px;"></a>
