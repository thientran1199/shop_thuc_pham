...
@section('content')
  ...
  <section id="aa-catg-head-banner">
   <img src="{{ asset('upload/sanpham/'.$sanpham->sanpham_anh) }}" alt="fashion img" style="width: 1920px; height: 300px;">
      ...
      <div class="row">
        ...
        <div class="aa-product-details-content">
          ...
          <div class="col-md-5 col-sm-5 col-xs-12">
            ...
            <a href="{{ asset('upload/sanpham/'.$sanpham->sanpham_anh) }}" class="MagicZoom" id="jeans" data-options="selectorTrigger: hover; transitionEffect: false;">
            <img src="{{ asset('upload/sanpham/'.$sanpham->sanpham_anh) }}" style="width: 250px; height: 300px;"></a>
             @foreach ($hinhsanpham as $hinh)
                <a data-zoom-id="jeans" href="{{ asset('upload/chitietsanpham/'.$hinh->hinhsanpham_ten) }}" data-image="{{ asset('upload/chitietsanpham/'.$hinh->hinhsanpham_ten) }}">
                <img src="{{ asset('upload/chitietsanpham/'.$hinh->hinhsanpham_ten) }}" style="width: 45px; height: 55px;">
                </a>
              @endforeach
          </div>
          </div>
