...
@section('content')
  ...
  @if (!is_null($khuyenmai))
   <img src="{{ asset('upload/khuyenmai/'.$khuyenmai->khuyenmai_anh) }}" alt="fashion img" style="width: 1920px; height: 300px;" >
   @else
   <img src="{{ asset('images/promotionpanel.jpg') }}" alt="fashion img" style="width: 1920px; height: 300px;" >
   @endif
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <li>
            <figure>
              <a class="aa-product-img" href="{{ url('san-pham',$sanpham->id,$sanpham->sanpham_url) }}"><img src="{{ asset('upload/sanpham/'.$sanpham->sanpham_anh) }}" style="width: 250px; height: 300px;" alt="polo shirt img"></a>
