            ...
            <div class="form-group">
                ...
                <div >
                    <select name="txtSPCate" id="input" class="form-control">
                        ...
                        <?php $selected = $val->id == $sanpham->loaisanpham_id ? 'selected' : '' ?>
                        <option {{ $selected }} value="{{ $val->id }}" >{{ $val->loaisanpham_ten }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div >
                    <select name="txtSPUnit" id="input" class="form-control">
                        ...
                        <?php $selected = $val->id == $sanpham->donvitinh_id ? 'selected' : '' ?>
                        <option {{ $selected }} value="{{ $val->id }}" >{{ $val->donvitinh_ten }}</option>
                        @endforeach
