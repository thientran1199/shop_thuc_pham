    ...
    <form action="" method="POST"  enctype="multipart/form-data">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label>Tên</label>
                <input class="form-control" name="txtLSPName" placeholder="Tên loại sản phẩm..." value="{{$loaisanpham->loaisanpham_ten}}" />
                <div>
                ...
                <div>
                    <select id="input" name="txtLSPParent"  class="form-control">
                            ...
                            @foreach ($nhom as $key => $val) {
                                <?php $selected = $val->id == $val->nhom_id ? 'selected' : '' ?>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label>Mô tả</label>
                <textarea class="form-control" rows="3" name="txtLSPIntro" placeholder="Mô tả...">{{ $loaisanpham->loaisanpham_mo_ta }}</textarea>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <br>
                <img src="{!! asset('resources/upload/loaisanpham/'.$loaisanpham->loaisanpham_anh) !!}" class="img-responsive img-rounded" alt="Image" style="width: 150px; height: 200px;">
                <input type="hidden" name="fImageCurrent" value="{!! $loaisanpham->loaisanpham_anh !!}">
                <br>
